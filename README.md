...
Este proyecto presenta una solución integral para el monitoreo de liquidez corporativa. El objetivo es demostrar habilidades técnicas en la integración de herramientas de análisis de datos (SQL, Excel y Power BI).

## 🛠️ Herramientas y Tecnologías
* **Base de Datos:** MySQL (Gestión de transacciones).
* **ETL & Limpieza:** Microsoft Excel (Power Query).
* **Visualización:** Power BI (DAX y Forecasting).
